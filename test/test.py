...
#-------------------
np.savetxt(fname="w0_"+str(train_times)+"times.csv", X=w0, fmt="%d",delimiter=",")
np.savetxt(fname="w1_"+str(train_times)+"times.csv", X=w1, fmt="%d",delimiter=",")
np.savetxt(fname="w2_"+str(train_times)+"times.csv", X=w2, fmt="%d",delimiter=",")
print(w2)