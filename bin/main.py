...
def get_data(y,sr):
    ...
    #librosa.amplitude_to_db(S, ref=1.0)    转dB

    #librosa.stft(y, n_fft=2048, hop_length=None, win_length=None, window='hann', center=True, pad_mode='reflect')      傅里叶变换

    #librosa.display.specshow(data,  x_axis=None, y_axis=None, sr=22050, hop_length=512)    获得频谱
